...
class FuzzyFinderExtension(Extension):
    ...
    def get_preferences(input_preferences: ExtensionPreferences) -> FuzzyFinderPreferences:
        preferences: FuzzyFinderPreferences = {
            "enter_action": AltEnterAction(int(input_preferences["enter_action"])),
            ...
            "terminal": input_preferences["terminal"]
        }
...
class KeywordQueryEventListener(EventListener):
    ...
    @staticmethod
    def _get_action(action_type: AltEnterAction, filename: str, terminal: str) -> BaseAction:
        dirname = KeywordQueryEventListener._get_dirname(filename)

        if action_type == AltEnterAction.OPEN_PATH_TERMINAL:
        ...
        def create_result_item(path_name: str) -> ExtensionSmallResultItem:
            return ExtensionSmallResultItem(
                ...
                on_enter=KeywordQueryEventListener._get_action(
                    preferences["enter_action"], path_name,
